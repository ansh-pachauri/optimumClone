  ...
  return (
    <>
      ...
      {/* image  */}
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-[#002864] bg-opacity-50 mt-[250px] ml-[300px] mr-[300px] mx-4 sm:mx-20 md:mx-32">
            <h1 className="text-white text-4xl sm:text-3xl md:text-4xl  font-bold">Let's Connect</h1>
        </div>
      </div>
      ...
      <div className="bg-gray-100 text-center  p-8 sm:p-6 md:p-8">
        <p className="text-[20px] sm:text-base md:text-lg italic text-gray-700 max-w-3xl mx-auto leading-relaxed sm:max-w-xl md:max-w-3xl font-sans">
