  ...
  return (
    <>
      ...
      <div className="bg-white text-center p-16 ">
        <p className="text-2xl font-bold text-blue-950 max-w-3xl mx-auto leading-relaxed font-sans">
      ...
      <div className="bg-gray-100 text-center  p-8">
        <p className="text-[20px]  italic text-gray-700 max-w-3xl mx-auto leading-relaxed  font-sans">
